...
<featureManager>
    ...
    <feature>servlet</feature>       <!-- required for JAX-RS dispatching -->
    <feature>jsonb</feature>         <!-- used to serialize MCP responses -->
    <feature>cdi</feature>           <!-- bean discovery for the portable extension -->
</featureManager>
```
